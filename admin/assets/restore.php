...
define("DB_NAME", 'checkdata');
define("DB_HOST", 'localhost');
define("BACKUP_DIR", 'BACKUP_DIR'); // Comment this line to use same script's directory ('.')
define("BACKUP_FILE", 'myphp-backup-crispdata-20190306_130616.sql.gz'); // Script will autodetect if backup file is gzipped based on .gz extension
define("CHARSET", 'utf8');
