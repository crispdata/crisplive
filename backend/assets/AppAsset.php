...
class AppAsset extends AssetBundle {
    ...
    public $css = [
        ...
        'assets/css/alpha.min.css?v=5',
        'assets/css/multiselect.css',
        'assets/css/daterangepicker.css',
        'assets/css/custom.css?v=167',
    ...
    public $js = [
        ...
        'assets/js/pages/form-wizard.js?v=2',
        'assets/js/alpha.min.js?v=8',
        'assets/js/pages/ui-modals.js',
        'assets/js/pages/form-select2.js?v=4',
        'assets/js/pages/table-data.js?v=198',
