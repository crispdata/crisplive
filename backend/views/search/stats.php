                ...
                <div class="card top">
                    <div class="card-content">
                        <div class="input-field col s12">
                            <form id="product-types" method = "post" action = "<?= $baseURL . 'search/stats' ?>">
                        ...
                        <?php if (isset($details) && count($details)) { ?>
                            ...
                            <div class="input-field col s5">
                                <input id="fromdate" type="text" name = "fromdate" placeholder='From Date' class="required fromdatepicker" autocomplete="off" value="<?php
                                if (@$_POST['fromdate']) {
                                    echo @$_POST['fromdate'];
                                }
                                ?>">
                            ...
                            <div class="input-field col s5">
                                <input id="todate" type="text" name = "todate" disabled="" placeholder="To Date" class="required todatepicker" autocomplete="off" value="<?php
                                if (@$_POST['todate']) {
                                    echo @$_POST['todate'];
                                }
                                ?>">
