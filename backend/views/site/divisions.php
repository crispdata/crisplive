...
<main class="mn-inner">
    <div class="row">
        ...
        <a class="waves-effect waves-light btn blue m-b-xs add-contact" href="<?= $baseURL ?>site/adddivision">Add Division</a>
                ...
                <div class="card-content">
                    ...
                    <table id = "current-project" class="responsive-table">
                        ...
                        <tbody id="contacts_list">
                            ...
                            if (@$divisions) {
                                $i = 0;
                                foreach ($divisions as $key => $direct) {
                                    ...
                                    <tr data-id = "<?= $direct->id ?>">
                                        ...
                                        <td ><a href="<?= Url::to(['site/change-division-status', 'id' => $direct->id]) ?>" class = "btn <?= $class ?>"><?= $status ?></a></td>
                                        <td>
                                            <a href="<?= Url::to(['site/adddivision', 'id' => $direct->id]) ?>" class="waves-effect waves-light btn blue">Edit</a>
                                ...
                                <div id="modal<?= $direct->id; ?>" class="modal">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="<?= Url::to(['site/delete-division', 'id' => $direct->id]) ?>" class=" modal-action modal-close waves-effect waves-green btn-flat">Yes</a>
                                    </div>
                                </div>
